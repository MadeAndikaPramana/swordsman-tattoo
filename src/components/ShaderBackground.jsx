// ShaderBackground — WebGL orb shader, adapted from 21st.dev Shader Builder
// ("dark" by @vodichka.vldk). Zero dependencies: one WebGL canvas that fills
// its parent. Palette retuned to the Swordsman ink/blood theme.
...
// Swordsman palette: ink black -> deep oxblood -> blood -> bright red core
const UNIFORMS = {
  colors: [
    [0.039, 0.035, 0.031], // #0a0908 ink
    [0.282, 0.09, 0.09],   // #481717 oxblood
    [0.549, 0.055, 0.086], // #8c0e16 dried blood
    [0.702, 0.071, 0.11],  // #b3121c blood
    [0.702, 0.071, 0.11],
    [0.702, 0.071, 0.11],
    [0.702, 0.071, 0.11],
    [0.702, 0.071, 0.11],
...
export default function ShaderBackground({ className }) {
  ...
  useEffect(() => {
    ...
    gl.uniform4f(uni.transform, UNIFORMS.seed, UNIFORMS.rotate, UNIFORMS.drift, 1.0)
